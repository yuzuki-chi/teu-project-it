...
--
-- ホスト: localhost
-- 生成日時: 2014 年 4 月 18 日 14:17
-- サーバのバージョン: 5.1.61-0+squeeze1
-- PHP のバージョン: 5.3.3-7+squeeze9
...
(207, '工科', '太郎', 'AWALSH', '600.507.9022', '2004-08-12', 'SH_CLERK', 5000, 0, 124, 50);
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `locations` (
  ...
  PRIMARY KEY (`location_id`),
   ...
   ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3201 ;
